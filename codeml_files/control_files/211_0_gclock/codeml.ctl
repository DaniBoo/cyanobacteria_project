      seqfile = 211.aa * sequence data filename
     treefile = 211.trees      * tree structure file name
...
*        ndata = 10
   ...
   aaRatefile = ../../../bin/jones.dat  * only used for aa seqs with model=empirical(_F)
